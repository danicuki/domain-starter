...
const tld = ".web3"
const CONTRACT_ADDRESS = "0x04A066BC867D7863efd4aD10757444eF96e5056C"
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder="what is your web3 power"
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">❤️♡ ♥💕❤😘 WEB3 Name Service</p>
              <p className="subtitle">Share your love to the new world!</p>
            </div>
